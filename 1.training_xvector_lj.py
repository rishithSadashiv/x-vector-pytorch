...
parser.add_argument('-training_filepath',type=str,default='meta/lj_training.txt')
parser.add_argument('-testing_filepath',type=str, default='meta/lj_testing.txt')
parser.add_argument('-validation_filepath',type=str, default='meta/lj_validation.txt')
