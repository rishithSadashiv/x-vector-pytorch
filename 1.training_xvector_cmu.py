...
parser.add_argument('-training_filepath',type=str,default='meta/cmu_training.txt')
parser.add_argument('-testing_filepath',type=str, default='meta/cmu_testing.txt')
parser.add_argument('-validation_filepath',type=str, default='meta/cmu_validation.txt')
...
def validation(dataloader_val,epoch):
    ...
    with torch.no_grad():
        ...
        model_save_path = os.path.join('save_model/cmu', 'best_check_point_'+str(epoch)+'_'+str(mean_loss))
